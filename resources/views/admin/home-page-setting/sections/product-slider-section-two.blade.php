@php
    $sliderSectionTwo = json_decode($sliderSectionTwo->value ?? 'None');
                        ...
                        <div class="form-group">
                            ...
                            <select name="cat_one" class="form-control main-category">
                                ...
                                @foreach ($categories as $category)
                                    <option {{ $category->id ?? 'None' == $sliderSectionTwo->category ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            @php
                                $subCategories = \App\Models\SubCategory::where(
                                    'category_id',
                                    $sliderSectionTwo->category ?? 'None'
                                )->get();
                            @endphp
                        ...
                        <div class="form-group">
                            @php
                                $childCategories = \App\Models\ChildCategory::where(
                                    'sub_category_id',
                                    $sliderSectionTwo->sub_category ?? 'None',
                                )->get();
                            @endphp
